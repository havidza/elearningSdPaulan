...
$readSoal = mysqli_query($koneksi, "SELECT * FROM soal WHERE id='$id_soal'");
...
if (isset($_POST["editSoal"])) {
    ...
    $updateSQL = mysqli_query($koneksi, "UPDATE soal SET soal='$soal', pil_a='$a', pil_b='$b', pil_c='$c', pil_d='$d', jawaban = '$jawaban' WHERE id='$id_soal'") or die($koneksi);
    if ($updateSQL) {
        echo "
                <script>
