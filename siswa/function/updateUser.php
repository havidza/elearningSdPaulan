<?php
    ...
    if ($row>=1) {
        $query = mysqli_query($koneksi, "UPDATE user SET nis='$nis', kelas='$kelas', nama='$nama', jk='$jk', wa='$wa', password=md5('$pwd2'), alamat='$alamat' WHERE id='$id' AND password=md5('$pwd1')") or die ($koneksi);
        if ($query) {
