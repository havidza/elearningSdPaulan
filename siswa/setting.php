...
<!-- Content -->
                <div class="row text-center">
                    <div class="col mx-3">
                        <h2 class="h2 text-dark mb-4">Data Pribadi</h2>
                    </div>
                </div>
                    ...
                    <div class="col-xxl-5">
                        <?php
                            ...
                            <form action="function/updateUser.php?id='.$row['id'].'" method="post" class="text-center mx-5">
                                ...
                                <input type="text" name="nis" class="form-control m-3 justify-content-center" value="'.$row['nis'].'" readonly>
                                <input type="text" name="kelas" class="form-control m-3 justify-content-center" value="'.$row['kelas'].'" readonly>
