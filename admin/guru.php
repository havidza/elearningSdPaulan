<?php
    ...
    require 'function/tambahGuru.php';
    require 'function/updateGuru.php';
    $sqlUser = "SELECT * FROM user WHERE role ='Guru'";
...
<div class="d-flex" id="wrapper">
        <div class="bg-3" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="guru.php" class="list-group-item list-group-item-action bg-transparent warna-1 fw-bold active-bar">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-2 py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 warna-1">Kelola Guru</h2>
                </div>
            </nav>
...
<!-- Content -->
                <div class="row my-5">
                  <!-- Button trigger modal tambah Guru -->
                  <button type="button" class="btn btn-primary btnInput mx-auto mb-3" data-bs-toggle="modal" data-bs-target="#modalTambahGuru">
                        <i class="fas fa-plus mx-2"></i>Tambah Guru
                  </button>
                  <!-- Modal tambah -->
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="modal fade" id="modalTambahGuru" tabindex="-1" aria-labelledby="modalTambahGuru" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <ul style="list-style-type: none;">
                                        <li>
                                            <label for="nama" class="me-3 fw-bold">Nama Guru</label>
                                            <input type="nama" name="nama" id="nama" class="mb-2 form-control w-75" required>
                                        </li>
                                        <li>
                                            <label for="nip" class="fw-bold">Nip</label>
                                            <input type="text" name="nip" id="nip" class="w-75 form-control w-75" required>
                                        </li>
                                        <li>
                  ...
                  <!-- Modal edit -->
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="modal fade" id="modalEditGuru" tabindex="-1" aria-labelledby="modalEditGuru" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <ul style="list-style-type: none;">
                                        ...
                                        <li>
                                            <label for="nip" class="fw-bold">Nip</label>
                                            <input type="text" name="nip" id="nip_edit" class="w-75 form-control w-75" required>
                                        </li>
                                        <li>
                                            <label for="judul" class="me-5 fw-bold d-block">Pilih kelas</label>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-primary" name="updateGuru">Update</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                          ...
                                          <div class="d-flex justify-content-center">
                                            <a href="#" 
                                              ...
                                              <form action="function/hapusGuru.php?id='.$row['id'].'" method="post">
                                                  '?><button type="submit" class="btn btn-danger" onclick="return confirm('Hapus Guru ?')"><i class="fas fa-trash me-2]"></i></button><?php echo '
                                              </form>
                                          </div>
                                          </td>
                                        </tr>';
...
<!-- Javascript -->
    ...
    <script>
        ...
        function openModalEdit(e){
          ...
          var nip = e.getAttribute('data-nip');
          var guru = e.getAttribute('data-guru');
