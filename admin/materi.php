<?php
    ...
    $query = mysqli_query($koneksi, "SELECT *, user.nama AS nama_guru, materi.id AS id_materi FROM materi INNER JOIN user ON materi.id_guru = user.id ORDER BY materi.id DESC");
    $query_guru = mysqli_query($koneksi, "SELECT * FROM user WHERE role = 'Guru'");
    $guru = array();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <ul style="list-style-type: none;">
                                        <li>
                                            <label for="judul" class="me-5 fw-bold d-block">Pilih Guru</label>
                                            <select class="form-select w-75" name="id_guru" id="guru" required>
                                        ...
                                        <li>
                                            ...
                                            <input type="text" name="judul" id="judul" class="w-75 form-control w-75" required>
                                        </li>
                                    </ul>
                                </div>
